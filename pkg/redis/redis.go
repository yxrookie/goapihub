...
// once: make sure the redis object only instantiate once
var once sync.Once

// Redis: the global Redis, use database 1
var Redis *RedisClient

// connect redis database, init global Redis object
...
func NewClient(address string, username string, password string, db int) *RedisClient {
	...
	// use the redis library's NewClient function
